...
!(function (e, t) {
			...
			((ScrollSmoother.register = function register(e) {
				return (
					M ||
						...
						s() &&
							window.document &&
							((L = window), (D = document), (O = D.documentElement), (U = D.body)),
						I &&
							((N = I.utils.toArray),
							(q = I.utils.clamp),
							(j = I.parseEase('expo')),
	...
	function ScrollSmoother(e) {
				...
				return arguments.length
					? ((m =
							...
							(function _wrap(e) {
								...
								return (
									t ||
										((t = D.createElement('div')).classList.add('ScrollSmoother-wrapper'),
		...
		z.forEach(function (e) {
			...
			e.effects &&
				this.effects(
					!0 === e.effects ? '[data-' + P + 'speed], [data-' + P + 'lag]' : e.effects,
					{}
				),
